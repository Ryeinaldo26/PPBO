...
class cetakNama(Abstract):
    def cetak(data):
        print(f"Nama    : {data.nama}")
class cetakNIM(Abstract):
    def cetak(data):
        print(f"NIM    : {data.nim}")
class cetakKelas(Abstract):
    def cetak(data):
        print(f"Kelas    : {data.kelas}")
class cetakJenisKelamin(Abstract):
    def cetak(data):
        print(f"Jenis Kelamin    : {data.jeniskelamin}")
class cetakNoHP(Abstract):
    def cetak(data):
        print(f"No. HP    : {data.nohp}")
class cetakNIP(Abstract):
    def cetak(data):
        print(f"NIP   : {data.nip}")
class cetakJabatan(Abstract):
    def cetak(data):
...
for data in acara:
    for proses in Abstract.__subclasses__():
        try:
            proses.cetak(data)
        except:
            continue
